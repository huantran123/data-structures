...
Graph.prototype.hasEdge = function(fromNode, toNode) {
  if (this.children[fromNode] === undefined || this.children[toNode] === undefined) {
    return false;
  }
  if (this.children[fromNode].children[toNode] !== undefined && this.children[toNode].children[fromNode] !== undefined) {
    return true;
  } else {
    return false;
  }
